...
\[
    D_b = 2\left[ t_b + \sum_{g\in\mathcal{G}_b} y_{gb}\log\left(\frac{y_{gb}}{\lambda_{gb}}\right) \right] \;.
\]
...
Finally, we correct for multiple testing by controlling the false discovery rate (FDR) using the Benjamini-Hochberg method \cite{benjamini1995controlling}.

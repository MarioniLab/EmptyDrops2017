...
In such cases, the estimate of the ambient expression profile will be biased, though this bias is likely to be small as relatively few transcripts will be contributed from cells with low RNA content.
...
This is mitigated to some extent by the use of designed cell barcodes in the GemCode protocol, which allows for error correction to a ``whitelist" \cite{zheng2017massively}.

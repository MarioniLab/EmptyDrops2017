...
and with the CellRanger approach, implemented as described \cite{zheng2017massively}.
...
For each method, we collected performance metrics across all iterations for further examination. 

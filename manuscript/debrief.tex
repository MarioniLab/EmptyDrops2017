...
\begin{flushleft}
{\Large
    \textbf\newline{Detecting empty droplets in droplet-based single-cell RNA sequencing data}
}
\newline
...
We named our method ``EmptyDrops'' and proceeded to test it on simulated data involving cells with different RNA content (see Methods).
Each simulated dataset was generated from real droplet-based scRNA-seq data and contained one group of large cells (i.e., high RNA content, large $t_b$), 
one group of small cells (low RNA content, small $t_b$), and a set of empty droplets with counts sampled from an ambient pool of RNA.
...
\begin{figure}[bt]
    \begin{center}
        \includegraphics[width=0.49\textwidth,trim=0mm 10mm 0mm 19mm,clip]{../simulations/results-sim/pics/pbmc4k_G1.pdf}
        \includegraphics[width=0.49\textwidth,trim=0mm 10mm 0mm 19mm,clip]{../simulations/results-sim/pics/pbmc4k_G2.pdf}
        \includegraphics[width=0.49\textwidth,trim=0mm 10mm 0mm 19mm,clip]{../simulations/results-sim/pics/pbmc4k_FDR.pdf}
        \includegraphics[width=0.49\textwidth,trim=0mm 19mm 0mm 10mm,clip]{../simulations/results-sim/pics/legend.pdf}
    \end{center}
...
Supplementary Table Y contains a brief summary of the datasets used in our study.
...
We identified the inflection point in the curve of $\log(t_b)$ against the log-rank using the \texttt{barcodeRanks} function from the \textsf{DropletUtils} package.
...
using the \texttt{downsampleMatrix} function from the \textsf{DropletUtils} package.
...
The various components of the simulation are visualized in Supplementary Figure X.

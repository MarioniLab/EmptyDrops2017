...
\note[id=n2]{The full list of participants is provided in Supplementary Table 1.} % note, connected to author
\end{artnotes}
...
Examination of another unique cluster indicated that it contained putative CD8\textsuperscript{+} T cells of maternal origin (Supplementary Figures~\suppfigrealplacenta{}a, b).
...
We also identified a cluster that may represent damaged cells stripped of cytoplasmic content (Supplementary Figures~\suppfigrealplacenta{}c, d).
...
In the PBMC dataset described previously, the EmptyDrops-only barcodes again formed a separate cluster corresponding to platelet-like cells (Supplementary Figure~\suppfigrealpbmc{}).
...
Data are available from the 10X Genomics website as described in Additional File 1: Table S2.
